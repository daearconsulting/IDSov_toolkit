...
class SovereigntyAudit:
    ...
    def __init__(self, dataset_name: str, reviewer: str = "", evidence_location: str = ""):
    ...
    def report(self) -> str:
        ...
        lines = [
            ...
            f"Reviewer   : {self.reviewer or 'Not recorded'}",
            f"Evidence   : {self.evidence_location or 'Not recorded'}",
            "Status     : Facilitated self-assessment; not legal, ethical, or governance certification.",
            f"",
        ]
        ...
        if overall is not None:
            ...
            lines += [
                f"INDICATIVE SELF-ASSESSMENT: {overall:.0f}/100  [{status}]",
                "",
                "BY FRAMEWORK",                
            ]
            for fw in self.frameworks:
        ...
        lines += [
            ...
            "Use only the frameworks the Nation has determined are applicable.",
